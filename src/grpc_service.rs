...
mod tests {
    ...
    async fn test_process_auth_step_password_correct() {
        ...
        let flow_token =
            crate::jwt::generate_flow_token("player1", "login", 0, &settings.jwt.secret, 600)
                .unwrap();
    ...
    async fn test_process_auth_step_password_incorrect() {
        ...
        let flow_token =
            crate::jwt::generate_flow_token("player2", "login", 0, &settings.jwt.secret, 600)
                .unwrap();
